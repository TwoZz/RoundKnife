...
DMC5480_API  DWORD  __stdcall d5480_conti_rel_helix_move(WORD card, long *rel_pos,long *rel_cen, long height, WORD arc_dir, long imark);
//绝对螺旋插补运动函数
DMC5480_API  DWORD  __stdcall d5480_conti_helix_move(WORD card, long *target_pos,long *cen_pos,long height, WORD arc_dir, long imark);
